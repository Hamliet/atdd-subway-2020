...
public class DataLoaderConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Line line1 = new Line("신분당선", "red lighten-1", LocalTime.now(), LocalTime.now(), 10, 500);
        Line line2 = new Line("2호선", "green lighten-1", LocalTime.now(), LocalTime.now(), 10, 0);
        Line line3 = new Line("3호선", "orange darken-1", LocalTime.now(), LocalTime.now(), 10, 300);

        line1.addLineStation(new LineStation(1L, null, 0, 0, 100));
        line1.addLineStation(new LineStation(3L, 1L, 3, 1, 100));

        line2.addLineStation(new LineStation(2L, null, 0, 0, 100));
        line2.addLineStation(new LineStation(1L, 2L, 3, 1, 100));

        line3.addLineStation(new LineStation(2L, null, 0, 0, 100));
        line3.addLineStation(new LineStation(4L, 2L, 2, 10, 100));
        line3.addLineStation(new LineStation(3L, 4L, 2, 10, 100));
